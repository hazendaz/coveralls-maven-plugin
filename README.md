...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.hazendaz.maven/coveralls-maven-plugin.svg)](https://central.sonatype.com/artifact/com.github.hazendaz.maven/coveralls-maven-plugin)
[![MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://opensource.org/licenses/MIT)

Maven plugin for submitting Java code coverage reports to [Coveralls](https://coveralls.io/) web
service.

### Offical Repo for coveralls with maven as listed [@coveralls](https://docs.coveralls.io/java) ###
